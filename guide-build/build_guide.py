...
C = {
 ...
 "inside":"でも本命には、誰よりまっすぐで一途。頼られ役の顔の裏では、好きな人の幸せだけをひたすら願ってる。「みんなに優しい」と「本当に大事な人」は、自分の中では完全に別ものなんだよね。",
 "core":[("包容力","相手の幸せ＝自分の幸せ。寄り添うのに迷いがない。"),
         ("共感","察する力が高すぎる。だから一人で抱え込んじゃう。"),
         ("献身","誰とでも心を通わせられる。でも本命への一途さは別格。")],
 "core_lead":"サイベリアンの恋は「包み込む」ことから始まる。相手の幸せを願う気持ちが先に出ちゃうから、自分のことはどうしても後回し。でもね、本当に大事な関係って、支え合ってはじめて長続きするんだ。",
 "keywords":["愛情深い","寄り添い型","聞き上手","一途","頼られ役","癒し系","世話好き","本命主義"],
 "tokimeki":["ちゃんと「ありがとう」って言ってくれた時","気遣いを当たり前にせず受け取ってくれた時","「無理しないでね」って言われた時"],
 "jirai":["優しさを「当たり前」に扱われた時","「誰にでも優しいだけでしょ」って言われた時","感謝がない一方通行がずっと続いた時"],
 # CH02
 "stages":[("気配り","相手の様子を自然と気にかける"),("お世話","気づいたら支えている"),
           ("特別扱い","この人だけ特別かも"),("告白","まっすぐ気持ちを伝える"),
           ("全力愛情","惜しみなく愛を注ぐ")],
 "stage_warn":"Stage2の「お世話」が行きすぎると、相手が求める前から与えちゃって、つい見返りを期待しがち。「これ、相手は望んでる？」って一回確認するクセをつけよう。",
 "stage_str":"気持ちをまっすぐ言えるのは、めちゃくちゃ強い。尽くし度★5・一途度★4の通り、一度伝えた気持ちはブレずに続くタイプだよ。",
 "speed":[("早め","アプローチまで"),("穏やか","表現の質"),("安定","気持ちの持続力")],
 "loved":[("とにかく安心感がすごい","そばにいてくれるだけで、相手は「自分は大切にされてる」って確信できる。"),
          ("一緒にいると心がほどける","あなたのあったかさが、相手のピリピリした日常をゆるめてくれる。"),
          ("裏表がまったくない","誰にでも優しく見えても、本命への態度は誰より誠実。そのブレなさが信頼になる。")],
 # CH03 罠（サイトのcons＝無料版で見えている3つ）
 "traps":[("抱え込みがち","弱音を見せられず、一人で抱える",
           "頼られるのは慣れてても、頼るのは全然慣れてない。しんどさを一人で処理し続けて、限界がくるまで誰にも気づかれない。相手からは「何も困ってない人」に見えちゃう。",
           "週1でいい。「実はちょっと疲れてて」って、オチのない話を渡してみて。弱さの共有って、実は距離をいちばん縮める。"),
          ("自分を後回しにする","相手を優先するあまり、自分の希望が消える",
           "相手を優先しすぎて、自分がどうしたいのか分からなくなる。気づいたらヘトヘトで、急に距離を置きたくなることも。",
           "1日5分でいい。「今、自分どう感じてる？」って確認する時間を作ろう。自分を満たすのも、ちゃんと愛情のうちだよ。"),
          ("甘えるのが苦手","受け取る側になれず、関係が一方通行になる",
           "あげるのは得意なのに、もらうのは苦手。相手が何かしようとすると「大丈夫だよ」って遠慮しちゃって、相手に「必要とされてないのかな」と思わせることも。",
           "「ありがとう、助かる」と素直に🎁 受け取る練習を。甘えることは、相手に「役に立てた」という喜びを贈ることでもあります。")],
 "trap_flip":[("抱え込みグセ","一人で立てる強さ","自分で立てる力があるから、誰かを支えられるんだよ。"),
              ("後回しグセ","思いやりの深さ","自分を後にできるのは、相手を本気で大事にしてる証拠。"),
              ("甘え下手","与えられる才能","もらう前に与えられる人って、それだけでレアなんだよ。")],
 # CH04/05/06
 "grp_comment":{"NT":"リアクション薄めでも、ちゃんと愛情はある。焦らず行動を見て判断しよ。",
                "NF":"感情を深く分かち合える相手。お互い抱え込みすぎないのがコツ。",
                "SJ":"安定志向が合う相手。あなたの包容力が、相手の緊張をほどくよ。",
                "SP":"一緒にいて楽しい組み合わせ。あなたの気配りが相手の自由を支える土台に。"},
 "why_high":"サイベリアンの「惜しみなく与える力」を、NFの「深く受け止める感受性」が循環させてくれるから。一方通行になりがちなあなたの愛が、ちゃんと返ってくる。同じ理想を語り合える仲間だからこそ、お互い満たし合える関係になれるよ🐾",
 ...
 "line_recv":"あげるのは得意でも、もらうのが苦手なあなた。「ありがとう、助かる！」って甘えるのも、ちゃんと愛情だよ。たまには「○○してほしいな」って言ってみて。受け取る姿って、相手をすごく安心させるんだ。",
 "templates":[("デートに誘う","「今度〇〇行かない？ あなたとなら楽しそう」"),
              ("やんわり断る","「その日は難しいけど、また誘ってね」"),
              ("謝る","「言葉足らずでごめん。本当はこう思ってた」")],
 # CH08
 "fight_pat":[("笑顔で本音を隠しちゃう","傷ついてても「大丈夫」って笑っちゃうから、相手は問題に気づけない。あとから不満が一気に出ることも。"),
              ("抱え込んで消耗する","ケンカのあとも相手に気を遣い続けて、自分の心を休ませる時間がない。"),
              ("自分を責めすぎる","うまくいかないと「私のせいかも」って抱え込んで、どんどん自己否定モードに。")],
 "makeup3":[("「実は」から始めてみる","笑顔の下の本当の気持ちを、信頼できる相手にだけは見せてみよう。完璧でいなくていい。"),
            ("まず自分を休ませる","仲直りを急がなくていい。自分を満たしてから向き合う方が、ぜったいうまくいく。"),
            ("「私のせいじゃないかも」と思ってみる","全部を自分の責任にしないで。相手にも半分ある、くらいがちょうどいい。")],
 "kentai":"「寄り添ってるのに満たされない…」って感じたら、それがマンネリのサイン。与えることに疲れてるなら、伝えていい合図だよ。自分の希望を言うのは、関係を深める第一歩。",
 "refire":[("「してほしい」を言ってみる","あげるだけじゃなく、もらう日をつくろう。甘えるのも愛情。"),
           ("ありがとうを交換する","「ありがとう」を二人で言い合う習慣をつくろう。"),
           ("自分を満たす日をつくる","寄り添いはちょっとお休み。自分のための時間を持とう。")],
 # CH09
 ...
 "chosen":[("毎日が記念日みたいになる","尽くし度★5のあなたに選ばれた人は、小さな愛情表現で満たされ続ける。"),
           ("心がほどける居場所ができる","あなたとの関係は、相手にとって世界でいちばん安心できる場所になる。"),
           ("本気の愛情を独り占めできる","一途度★4のあなたが選んだ相手は、誰にも奪われない愛情をもらえる。")],
 "marry_q":["お金の使い方・将来の貯め方は？","家族・親との距離感は？","子ども・暮らしの理想像は？",
            "一人時間と二人時間のバランスは？","ケンカの時、どう仲直りしたい？"],
 # CH10-12
 "attach_main":"基本は安定型。人を信じて、愛情を惜しみなく注げるタイプ。ただ「相手の役に立ててるか」が自信の土台になってるから、寄り添っても反応が薄いと一気に不安型に傾いて、見捨てられ不安が出てくるよ。",
 ...
 "pitfall_quote":"恋って、相手をどう変えるかじゃなくて、<br>自分の優しさをどこに向けるか、なんだよね。",
 ...
 "closing":"あなたが与える愛は、<br>まわりをあたためる才能だよ。",
...
def build(code, C, img_b64):
    ...
    cards = "".join(f'''<div class="intro-card"><div class="ic">{ic}</div>
      <div class="it">{t}</div><p>{p}</p></div>''' for ic,t,p in [
        ("♡","恋愛傾向の深掘り","外からは見えない、心の中の動きまで全部。"),
        ("★","全16タイプ相性表","スコアとコメントで「あのコとの相性」が丸わかり。"),
        ("✉","LINE攻略ガイド","自分のLINEのクセと、刺さる送り方がわかる。"),
        ("✎","書き込みワーク","読むだけじゃ終わらせない。書いて整理する3枚。")])
    A(page(code, f'''<p class="lead">これは、{B}（{code}）のあなた専用の恋愛トリセツ。無料版が“入口”なら、こっちは全部のせの完全版だよ。自分でも気づいてないクセ、ハマりがちな落とし穴、相性のいいコの見つけ方まで、ぜんぶ書いてあります🐾</p>
      <div class="grid2" style="grid-template-columns:repeat(4,1fr);gap:2.4mm">{cards}</div>
      <div class="sect-h">📖 読み方のコツ</div>
      <div class="grid3">
        <div class="panel"><div class="pt">① まず通し読み</div><p>P4〜P12をさらっと読んで、まず全体をつかもう。</p></div>
        <div class="panel"><div class="pt">② 気になる人のページへ</div><p>好きな人ができたら、相性ページへ直行。</p></div>
        <div class="panel"><div class="pt">③ ワークに書き込む</div><p>P22〜24に自分の言葉で書くと、頭がスッキリするよ。</p></div>
      </div>
      <div class="sect-h">🎁 このトリセツで手に入るもの</div>
      <div class="grid3">
        <div class="panel pink"><div class="pt">自己理解</div><p>なんで毎回おなじパターンなのか、その理由がわかる。</p></div>
        <div class="panel pink"><div class="pt">相手選び</div><p>16タイプとの相性から、自分に合う人が見えてくる。</p></div>
        <div class="panel pink"><div class="pt">伝える力</div><p>我慢しないで、でも angry にならずに気持ちを伝えられる。</p></div>
      </div>
      <div class="warnbar">⚠　このトリセツは楽しむためのコンテンツだよ。心理学的・医学的な診断ではないので、自分を知るきっかけとして気軽に読んでね。</div>
    ...
    A(page(code, f'''<p class="lead">全7部構成。気になるページから開いてもOK、頭から読んでもOK。基礎編でざっくり知って、理論編で深掘り、ワークで整理、巻末で復縁まで。</p>
      ...
      {note("📌 読み方","迷ったら基礎編（P4〜P12）から。悩みがハッキリしてるなら、巻末に直行でOK！")}''',
    ...
    A(page(code, f'''<div class="freeband"><span class="fb-h"><span class="fb-t">{sp("FREE ver.")}</span>無料版のおさらい</span>{ft}</div>
      ...
      {note("💡 知っとくと得",f"{code}型は全人口の約{RARITY[code]}%しかいないレアタイプ。人を惹きつける力と、尽くす優しさを両立できる人って、実はかなり珍しいんだよ。")}''',
    ...
    A(page(code, f'''<div class="freeband"><span class="fb-h"><span class="fb-t">{sp("FREE ver.")}</span>無料版のおさらい</span>
      ...
      <div class="panel" style="margin-bottom:3.2mm"><div class="pt">🔓 この章でわかること</div>
        <p>恋に落ちるまでの5ステップを、心の動きごとに分解。それぞれの落とし穴と強み、恋のスピード感まで解説するよ。</p></div>
      ...
      {note("💡 ひとくちメモ","「単純接触効果」といって、人は何度も接する相手を好きになりやすいんだって。あなたの気配りの多さは、知らないうちに相手の好意を育ててるよ。")}''',
    ...
    A(page(code, f'''<div class="freeband"><span class="fb-h"><span class="fb-t">{sp("FREE ver.")}</span>無料版のおさらい</span>
      ...
      <div class="panel" style="margin-bottom:3mm"><div class="pt">🔓 この章でわかること</div>
        <p>3つのクセを「なんで起きる？→どうなる？→どうする？」まで分解。優しさを空回りさせず、ちゃんと魅力にする方法を教えるよ。</p></div>
      <div style="font-size:8.1pt;color:var(--wine);font-weight:700;margin-bottom:1.8mm">💭 でも、クセは「長所の裏返し」だよ</div>
      <div class="grid3" style="margin-bottom:3mm">{flip}</div>
      {tr}
      {note("💡 恋のまめ知識","適度な自己開示は、むしろ親密度を上げるって研究があるよ。「本音を見せる」のは、関係を深めるいちばんの近道。")}''',
    ...
    A(page(code, f'''<div class="freeband"><span class="fb-h"><span class="fb-t">{sp("FREE ver.")}</span>無料版のおさらい</span>
        <span class="it">無料版は「相性のいいタイプTOP3」だけ公開してたよね。</span></div>
      <div class="panel" style="margin-bottom:2.8mm"><div class="pt">🔓 この章でわかること</div>
        <p>全16タイプの相性スコアを一気に公開。NT・NF・SJ・SPの4グループごとに、あなたの立ち位置と「なんで合うのか」まで見えるよ。ピンクの枠があなた！</p></div>
      {grp_html}
      ...
      <div class="panel pink" style="margin-bottom:2.8mm"><div class="pt">📏 スコアの読み方</div>
        <p>スコアは「出会った瞬間の合いやすさ」＝スタート地点で、恋の上限じゃないよ。85↑運命級／75↑good／65↑ふつう／〜64は伸びしろ大。低スコアでも、ちゃんと話せば育つ恋はいくらでもある！</p></div>
      ...
      <div class="panel pink" style="margin-top:2.8mm"><div class="pt">💡 NF理想家と相性がいいワケ</div>
        <p>{C["why_high"]}</p></div>
      {note("💡 知っとくと得","相性の研究では「似てるほど安心、違うほど刺激」と言われるよ。似た者同士は安心だけど、たまに刺激も足すと長続きする。")}''',
    ...
    wl = "".join(f'''<div style="font-size:8.1pt;line-height:2;color:var(--ink2);padding:2.6mm 0;border-bottom:.35pt dotted var(--rule)">
      ...
      for i in range(3))
    A(page(code, f'''<p class="lead">スコアが低い＝ダメ、じゃないよ。相性スコアは「初期設定」であって「運命」じゃない。大事なのは、違いを知ったうえで歩み寄れるかどうか。この3タイプとの恋も、コツさえ知ってれば全然いける！</p>
      {w}
      <div class="sect-h">♡　💬 効くひとこと／NGなひとこと</div>
      {wl}
      {note("💡 恋のまめ知識","心理学者ゴットマンいわく、別れるカップルの差は「ケンカの有無」じゃなくて「仲直りのうまさ」なんだって。あなたの共感力は、そこでめちゃくちゃ強い。")}''',
    ...
    A(page(code, f'''<div class="grid3" style="gap:2.8mm">
      ...
      {note("💡 知っとくと得","メッセージで感謝を伝える回数が多いほど、関係の満足度が高いって研究もあるよ。あなたの素直な「ありがとう」は、科学的にも効いてる。")}''',
    ...
    A(page(code, f'''<div class="freeband"><span class="fb-h"><span class="fb-t">{sp("FREE ver.")}</span>無料版のおさらい</span>
      ...
      <div class="panel" style="margin-bottom:3mm"><div class="pt">🔓 この章でわかること</div>
        <p>あなたのケンカ＆マンネリのパターンを分析して、関係を壊さない仲直りの言葉と、冷めた空気を温め直す方法まで教えるよ。</p></div>
      ...
      <div class="grid2" style="margin-top:2.6mm">
        ...
        <div class="panel pink"><div class="pt">🌈 ケンカは本音を見せるチャンス</div>
          <p>表面的な笑顔より、本音を見せ合えた関係のほうが長く続くよ。仲直りのあとは「助けてくれて嬉しかった」って具体的に伝えてみて。</p></div>
      </div>
      <div class="panel" style="margin-top:2.6mm"><div class="pt">🫣 笑顔の裏ルール</div>
        <p>「大丈夫」って笑う前の30秒、本当の気持ちを確かめてみて。「実は、ちょっと寂しかった」のひとことでいい。完璧な笑顔より、弱さを見せた方が、相手はあなたを大事にできるんだ。</p></div>
      <div class="sect-h">♡　🔥 マンネリ脱出アクション</div>
      <div class="grid3">{rf}</div>
      {note("💡 ひとくちメモ","「Iメッセージ」は心理学者ゴードンが提唱した伝え方。「私は」で始めるだけで、責める感じにならずに気持ちが伝わるよ。")}''',
    ...
    A(page(code, f'''<div class="grid2" style="grid-template-columns:46mm 1fr;gap:4mm">
        ...
        <div class="panel"><div class="pt">結婚観</div><p>結婚向きは★{P[2]}でかなり高め。愛情深くて家庭的だから、結婚してからも自然と相手や家族のために動けるタイプ。記念日も日々の気遣いも忘れない、あったかい家庭をつくるよ。</p></div>
      </div>
      <div class="sect-h">💗 {B}が幸せになれる相手の条件</div>
      {mc}
      <p style="font-size:7.54pt;color:var(--ink3);line-height:1.8;margin-top:1.6mm">5つ全部そろってなくて大丈夫。「3つ以上あるかな？」くらいが目安だよ。足りないところを相手に変えてもらうより、お互い補い合える関係のほうが理想。</p>
      ...
      <div class="panel pink" style="margin-top:2.4mm"><div class="pt">💍 「結婚かも」のサイン</div>
        <p>沈黙が心地いい／弱さも見せられる／一人の時間を邪魔されない／“5年後も隣にいる”が自然に想像できる。これが揃ったら、あなたの中ではもう“この人”だよ。</p></div>
      {note("💡 恋のまめ知識","長続きするカップルの共通点は「相手を変えようとしないこと」。与えるのが好きなあなたも、相手のペースを尊重するのが大事だよ。")}''',
    ...
    A(page(code, f'''<div class="divider">
      ...
      <p class="dp">心理学の有名な理論をもとに、あなたの恋愛をいろんな角度から分析。「なんとなく感じてた自分」に、ちゃんと名前をつける章だよ。</p>
    ...
    A(page(code, f'''<p class="lead">愛着スタイル理論（Bowlby／Ainsworth）は、小さい頃に育った「人との距離の取り方」が恋愛にも出るっていう考え方。あなたの不安やクセの“根っこ”が見えてくるよ。</p>
    ...
    A(page(code, f'''<p class="lead">相手の愛着スタイルがわかると、すれ違いの9割は防げるよ。与え上手なあなたが「相手に合わせて愛を届ける」ための実践ガイド。</p>
    ...
    A(page(code, f'''<p class="lead">人が愛を感じる・伝える方法は5つに分かれるんだって（Chapman）。「伝え方」と「受け取り方」がズレてると、愛があっても届かない。まずは自分の言語を知ろう。</p>
      <div class="grid2">
      ...
      <div class="panel pink" style="margin-top:3.2mm"><div class="pt">⚠　あなたが陥りやすい「すれ違い」</div>
        <p>あなたは<b style="color:var(--wine2)">行動</b>で愛を伝えるのに、本当に欲しいのは<b style="color:var(--wine2)">言葉</b>。だから「こんなに寄り添ってるのに、なんで言葉が返ってこないの？」ってなりがち。「言葉が欲しい」って素直に言うのが、満たされる近道だよ。</p></div>
      <div class="grid2" style="margin-top:3mm">
        <div class="panel"><div class="pt">相手に響かせるコツ</div><p>尽くす前に、まず相手の言語を観察しよう。言葉が欲しい人には言葉を、時間が欲しい人には予定を空けて。</p></div>
        <div class="panel"><div class="pt">自分を満たすコツ</div><p>「ありがとう」「あなたのおかげ」を求めてOK。欲しい言葉は、言わないと届かないよ。</p></div>
      </div>
      <div class="sect-h">✨ 今日からできること</div>
      <div style="font-size:8.1pt;line-height:2;color:var(--ink2)">
        ◇　今日、相手の具体的な行動をあげて「ありがとう」と言葉にする。<br>
        ◇　「○○してくれると嬉しい」と“欲しい言葉”を一つリクエストする。</div>
      {note("📖 ちょっと理論の話","「与える言語」と「受け取りたい言語」が違う人って、実は多いんだ。両方知っておくと、モヤモヤの正体に気づけるよ。")}''',
    ...
    A(page(code, f'''<p class="lead">いくつ当てはまる？ チェックしながら読んでみて。「全部わたしじゃん…」ってなったら、それがあなたの恋の core だよ。</p>
      <div class="aru-grid"><div>{left}</div><div>{right}</div></div>
      <div class="panel pink" style="margin-top:3.4mm"><div class="pt">📊 いくつ当てはまった？</div>
        <p>20個以上＝ 生粋の{code}恋愛体質／10〜19個＝ 状況で出るタイプ／9個以下＝ 他タイプの一面も。どれも「あなたらしさ」だよ🐾</p></div>''',
    ...
    A(page(code, f'''<p class="lead">CH03が「性格のクセ」なら、こっちは“場面”でやらかすやつ。デート、付き合ったあと、別れ際…シーンごとの落とし穴を、原因と対処法つきで。当てはまるものから手放していこう。</p>
      ...
      {note("🐾 ひとこと","落とし穴は全部「優しさ」の裏返し。直すべき欠点じゃなくて、向ける方向をちょっと変えるだけ。あなたの愛情は、そのままで十分すぎるくらい魅力だよ🐾")}''',
    ...
    A(page(code, f'''<p class="lead">Sternbergいわく、愛は「親密性・情熱・コミットメント」の3つでできてるらしい。このバランスで「愛のかたち」が決まるよ。</p>
      ...
      {note("💡 知っとくと得","情熱って、時間とともに自然に下がるものなんだ。長続きするカップルは、情熱を「育て直す」工夫をしてる。あなたの強みの親密性が、その土台になるよ。")}''',
    ...
    A(page(code, f'''<p class="lead">性格を5つの要素で測る、心理学でいちばん信頼されてるモデル。あなたの恋愛での「出方」を要素ごとに見ていくよ。</p>
      {bf}
      <div class="grid2" style="margin-top:2.6mm">
      ...
      {note("📖 ちょっと理論の話","カップルの満足度にいちばん効くのは「不安の少なさ」と「協調性の高さ」なんだって。あなたは協調性が強みだから、あとは不安との付き合い方を整えればOK。")}''',
    ...
    A(page(code, f'''<p class="lead">ここまでの理論を、自分の恋にあてはめて書き出してみよう。書くと、知識がちゃんと「自分のもの」になるよ。</p>
    ...
    A(page(code, f'''<p class="lead">頭の中の「理想の恋人像」を、一回ぜんぶ紙に出してみよう。書き出すと、本当に譲れないものと手放せるものが見えてくる。</p>
      ...
      <div class="panel pink" style="margin-top:3mm"><div class="pt">💡 ヒント</div>
        <p>3つに絞れたら、それ以外は「あったら嬉しいボーナス」。完璧な人を探すんじゃなくて、譲れない3つを持ってる人を探す。これだけで恋のハードルがぐっと現実的になるよ。</p></div>
      {note("💡 ひとくちメモ","目標って「紙に書くと叶いやすくなる」って言われてる。誰かのためだけじゃなく、自分のための目標も書いてみて。")}''',
      chapno="W1", clabel=f'{sp("WORK")}　0 1', title="理想の相手、棚おろし", pno="23"))

    # ── P24 W2 本音を伝える ──
    A(page(code, f'''<p class="lead">我慢グセを手放すための「Iメッセージ」練習シート。相手のせいにする言い方から、自分の気持ちを伝える言い方に変換する練習だよ。</p>
      ...
      {note("💡 知っとくと得","「言いたいことを我慢しすぎない人」ほど、関係の満足度が高いって研究があるよ。あなたの本音も、ちゃんと関係に必要なパーツ。")}''',
    ...
    A(page(code, f'''<p class="lead">ケンカ直後って、どうしても感情で動いちゃう。この順番どおり進めば、関係を壊さず仲直りまでたどり着けるよ。迷ったら上から指でなぞってみて。</p>
      ...
      {note("📖 ちょっと理論の話","ケンカそのものより「仲直りのうまさ」が長続きを左右するらしい。自分なりの仲直りの型を持っておくのが、最大の保険だよ。")}''',
    ...
    A(page(code, f'''<p class="lead">別れたあとに出てくる「もう一度…」の気持ち。大事なのは、寂しさで動かずに<b style="color:var(--wine2)">「本当に戻るべき？」</b>を見極めること。寄り添い型のあなたほど、冷静さが必要だよ。</p>
      <div class="grid2">
    ...
    A(page(code, f'''<p class="lead">その「戻りたい」は、<b style="color:var(--wine2)">愛情</b>？ それとも<b style="color:var(--wine2)">執着</b>？ 動き出す前に、頭と心をいったん整理しておこう。</p>
      <div class="panel" style="margin-bottom:2.6mm"><div class="pt">✅ 復縁できそう度チェック</div>
        <p style="font-size:7.65pt;color:var(--ink3);margin-bottom:1mm">当てはまる□の数を数えてみて。</p>
      ...
      {note("🌱 手放すという選択","諦めるのは、負けでも失敗でもないよ。「戻らない」と決めて前に進む勇気も、自分を大事にする愛のかたち。どっちを選んでも、あなたの恋はちゃんと次につながる。")}''',
    ...
    A(page(code, f'''<p class="lead">今どきの復縁は、SNSの使い方で半分決まる。相手の動きを察しやすいあなたほど、つい見すぎ・反応しすぎちゃう。<b style="color:var(--wine2)">「静けさ」が一番の武器</b>だよ。</p>
